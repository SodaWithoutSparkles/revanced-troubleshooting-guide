...
For Windows users, visit [ReVanced CLI Initialize Guide (Windows)](/10-cli-init-windows.md).
For Linux users, visit [ReVanced CLI Initialize Guide (Linux)](/09-cli-init-linux.md).
